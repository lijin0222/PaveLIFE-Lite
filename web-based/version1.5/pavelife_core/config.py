...
default_analysis_settings = {
    ...
    "share_of_directional_traffic_during_work_hours": legacy.share_of_directional_traffic_during_work_hours,
    "peak_hour_multiplier": legacy.peak_hour_multiplier,
    "work_zone_capacity_per_open_lane_vehph": legacy.work_zone_capacity_per_open_lane_vehph,
    "mr_open_lanes": legacy.mr_open_lanes,
