...
def build_parameter_documentation_df():
    ...
    rows = [
        ...
        ("share_of_directional_traffic_during_work_hours", share_of_directional_traffic_during_work_hours, "fraction", "all", "Share of daily directional traffic exposed to active work hours."),
        ("peak_hour_multiplier", peak_hour_multiplier, "dimensionless", "all", "Multiplier converting average work-hour demand to peak-hour demand."),
